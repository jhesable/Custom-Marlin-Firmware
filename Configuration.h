...
#define MACHINE_UUID "59c0fd96-73f4-4666-8815-2eb15ca6d94b"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -0.5, -2.45 }
...
#define Y_MAX_POS Y_BED_SIZE-0.5
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 37, 30 } // (mm) Left, Front, Right, Back insets
 ...
 *
 * :[ 'ORIGIN', 'FYSETC', 'HYPRECY', 'MKS', 'RELOADED', 'F', 'E3S1PRO', 'CREALITY_TOUCH' ]
 */
